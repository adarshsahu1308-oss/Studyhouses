          ...
          <div className="prose prose-gray dark:prose-invert max-w-none">
            ...
            <section className="mb-8">
              ...
              <p className="text-gray-700 dark:text-gray-300 mb-4">
                Welcome to StudyHouse. We are committed to protecting your privacy and ensuring the security of your personal information. This Privacy Policy explains how we collect, use, disclose, and safeguard your information when you use our academic resource sharing platform.
              </p>
              <p className="text-gray-700 dark:text-gray-300">
                By using StudyHouse, you agree to the collection and use of information in accordance with this policy.
              </p>
            </section>
            ...
            <section className="mb-8">
              ...
              <div className="bg-gray-50 dark:bg-gray-700 rounded-lg p-4">
                <ul className="text-gray-700 dark:text-gray-300 space-y-2">
                  <li><strong>Email:</strong> privacy@StudyHouse.com</li>
                  <li><strong>Address:</strong> StudyHouse Privacy Team</li>
