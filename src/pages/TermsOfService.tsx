          ...
          <div className="prose prose-gray dark:prose-invert max-w-none">
            ...
            <section className="mb-8">
              ...
              <p className="text-gray-700 dark:text-gray-300 mb-4">
                Welcome to StudyHouse, an academic resource sharing platform designed for college students. These Terms of Service ("Terms") govern your use of our website and services.
              </p>
              <p className="text-gray-700 dark:text-gray-300">
                By accessing or using StudyHouse, you agree to be bound by these Terms. If you disagree with any part of these terms, then you may not access the service.
              </p>
            </section>
            ...
            <section className="mb-8">
              ...
              <ul className="list-disc list-inside text-gray-700 dark:text-gray-300 space-y-2">
                <li>StudyHouse and its features are protected by intellectual property laws</li>
            ...
            <section className="mb-8">
              ...
              <p className="text-gray-700 dark:text-gray-300">
                These Terms are governed by and construed in accordance with applicable laws. Any disputes will be resolved through appropriate legal channels in the jurisdiction where StudyHouse operates.
              </p>
            </section>
            ...
            <section className="mb-8">
              ...
              <div className="bg-gray-50 dark:bg-gray-700 rounded-lg p-4">
                <ul className="text-gray-700 dark:text-gray-300 space-y-2">
                  <li><strong>Email:</strong> legal@StudyHouse.com</li>
                  <li><strong>Address:</strong> StudyHouse Legal Team</li>
            ...
            <section className="mb-8">
              <div className="bg-blue-50 dark:bg-blue-900/20 border border-blue-200 dark:border-blue-800 rounded-lg p-4">
                ...
                <p className="text-blue-700 dark:text-blue-300">
                  By using StudyHouse, you acknowledge that you have read these Terms of Service and agree to be bound by them. Thank you for being part of our academic community!
                </p>
              </div>
            </section>
          </div>
