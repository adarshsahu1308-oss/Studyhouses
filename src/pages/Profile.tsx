                      ...
                      <div className="mt-4">
                        ...
                        <div className="text-sm text-gray-600 dark:text-gray-400  py-3" >
                          ...
                          or if you do not receive a response from us with in two days  of applying , <br />
                            please feel free to contact us via email: <a className='text-gray-300' href="mailto:geetathakurr13@gamil.com cse22_adarshsahu@ggct.co.in cse22_aakankshagendiya@ggct.co.in">geetathakurr13@gamil.com | cse22_adarshsahu@ggct.co.in | cse22_aakankshagendiya@ggct.co.in</a>
                        </div>
                      </div>
                    )}
                  </div>
